...
import com.example.fitapp.ui.home.Timer;
...
public class TodayActivityAdapter extends RecyclerView.Adapter<TodayActivityAdapter.TodayActivityViewHolder> {
    ...
    // Constructor
    public TodayActivityAdapter(Context context, List<Exercise> exerciseList, String mode, User user, boolean isAdmin) {
    ...
    public void onBindViewHolder(@NonNull TodayActivityViewHolder holder, int position) {
        ...
        holder.actionButton.setOnClickListener(v -> {
            if (mode.equals("activity_today")) {
                // Navigate to TimerActivity with exercise details
                ...
                intent.putExtra("EXERCISE_CATEGORY", exercise.getExerciseCategory());
                intent.putExtra("EXERCISE_PIC_PATH", exercise.getExercisePicPath());
                int resid = exercise.getDrawableResId();
                intent.putExtra("EXERCISE_IMAGE_RESID", resid);
