...
public class ExerciseDataUploader {
    ...
    public void uploadExercises() {
        ...
        exercises.add(new Exercise("Pilates", "Flexibility", "", R.drawable.pilates, 40, 200));
        exercises.add(new Exercise("Side Lunges", "Flexibility", "", R.drawable.side_lungs, 10, 50));
        exercises.add(new Exercise("Seated Hamstring Stretch", "Flexibility", "", R.drawable.seated_hamstring_stretch, 10, 30));
        exercises.add(new Exercise("Cat-Cow Stretch", "Flexibility", "", R.drawable.catcow_stretch, 10, 25));
        exercises.add(new Exercise("Chest Opener Stretch", "Flexibility", "", R.drawable.chest_opener_stretch, 10, 25));
        ...
        for (Exercise exercise : exercises) {
            ...
            String exerciseId = newExerciseRef.getKey();
